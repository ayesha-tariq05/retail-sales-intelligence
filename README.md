...
1. **Clone the repo:** `(https://github.com/ayesha-tariq05/retail-sales-intelligence)
`
2. **Environment:** Ensure you have the necessary libraries installed: 
   `pip install pandas prophet`
3. **Explore:** Run the notebooks in sequential order (01 -> 02-> 03-> 04).
